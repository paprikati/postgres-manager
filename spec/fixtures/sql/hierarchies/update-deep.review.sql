...
UPDATE children SET name = 'Child 1-0', parent_id = $3, grandparent_id = $1 WHERE id = $4
UPDATE children SET name = 'Child 1-1', parent_id = $3, grandparent_id = $1 WHERE id = $5
UPDATE children SET name = 'New Child Name', parent_id = $2, grandparent_id = $1 WHERE id = $6
UPDATE children SET name = 'Child 0-1', parent_id = $2, grandparent_id = $1 WHERE id = $7
